...
import com.stratio.connector.decision.core.exception.ConnectionProcessException;
import com.stratio.connector.decision.core.procces.ConnectorProcess;
import com.stratio.connector.decision.core.procces.ConnectorProcessHandler;
import com.stratio.connector.decision.core.procces.QueryProcess;
...
/**
 * This class is a Decision implementation for queryEngine.
 */
public class DecisionQueryEngine implements IQueryEngine {
     ...
     *            the processor handler.
     */
    public DecisionQueryEngine(ConnectionHandler connectionHandler, ConnectorProcessHandler processHandler) {
    ...
    public QueryResult execute(String queryId, LogicalWorkflow workflow) throws UnsupportedException, ExecutionException {
        throw new UnsupportedException("execute not supported in Decision connector");
    }
	...
	public void pagedExecute(String queryId, LogicalWorkflow workflow,
        ...
        throw new UnsupportedException("Page Execute not supported in Decision connector");
