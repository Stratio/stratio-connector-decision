...
import com.stratio.connector.decision.core.engine.query.ConnectorQueryBuilder;
import com.stratio.connector.decision.core.engine.query.ConnectorQueryData;
import com.stratio.connector.decision.core.engine.query.ConnectorQueryParser;
import com.stratio.connector.decision.core.engine.query.queryexecutor.ConnectorQueryExecutor;
    ...
    public void run() {
        try {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("The decision query is: [" + query + "]");
            ...
            String msg = "Decision query execution fail." + e.getMessage();
            logger.error(msg);
