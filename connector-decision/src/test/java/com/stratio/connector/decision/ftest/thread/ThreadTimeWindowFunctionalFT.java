...
public class ThreadTimeWindowFunctionalFT extends GenericDecisionTest {
    ...
    public void stopWriteBeforeStopReadTest() throws InterruptedException, UnsupportedException {
        ...
        DecisionRead stremingRead = new DecisionRead(sConnector, logicalWokflow, resultHandler);
