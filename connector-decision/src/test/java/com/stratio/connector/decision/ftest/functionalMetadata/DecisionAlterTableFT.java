 ...
 * under the License.
 */
package com.stratio.connector.decision.ftest.functionalMetadata;
...
import com.stratio.connector.decision.ftest.helper.DecisionConnectorHelper;
...
public class DecisionAlterTableFT extends GenericMetadataAlterTableFT {

    @Override
    protected IConnectorHelper getConnectorHelper() {
        DecisionConnectorHelper sConnectorHelper = null;
        try {
            sConnectorHelper = new DecisionConnectorHelper(getClusterName());
    ...
    public void addColumnFT() throws ConnectorException {
        ...
        DecisionResultHandler strResultHandler = new DecisionResultHandler();
        DecisionRead decisionReader = new DecisionRead((DecisionConnector) connector, lw, strResultHandler);
        decisionReader.setQueryId(UUID.randomUUID().toString());
...
class DecisionResultHandler implements IResultHandler {
    // boolean assertsMatch;
    // String column;
    // String value;
    List<QueryResult> queryResult;

    // public DecisionResultHandler(String column, Object value) {
    // assertsMatch=false;
    // // TODO Auto-generated constructor stub
    // }

    public DecisionResultHandler() {
