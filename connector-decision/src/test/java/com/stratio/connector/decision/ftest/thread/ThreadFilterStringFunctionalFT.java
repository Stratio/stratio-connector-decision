...
public class ThreadFilterStringFunctionalFT extends GenericDecisionTest {
    ...
    public void testEqualFilter() throws InterruptedException, UnsupportedException {
        ...
        DecisionRead stremingRead = new DecisionRead(sConnector, createEqualLogicalWorkFlow(),
        ...
        DecisionInserter decisionInserter = new DecisionInserter(sConnector, getClusterName(), tableMetadata, new RowToInsertDefault());
        decisionInserter.setAddIntegerChangeable(true);
        decisionInserter.numOfElement(CORRECT_ELMENT_TO_FIND);
        ...
        otherDecisionInserter.changeStingColumn(OTHER_TEXT);
    ...
    public void distinctFilterTest() throws InterruptedException, UnsupportedException {
        ...
        DecisionRead stremingRead = new DecisionRead(sConnector, createDistinctLogicalWorkFlow(),
                        new ResultTextHandler());
        ...
        oherDecisionInserter.changeStingColumn(OTHER_TEXT);
        oherDecisionInserter.numOfElement(CORRECT_ELMENT_TO_FIND);
