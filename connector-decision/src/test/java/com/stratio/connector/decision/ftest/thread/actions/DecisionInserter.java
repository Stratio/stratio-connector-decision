...
public class DecisionInserter extends Thread {
    ...
    public DecisionInserter(DecisionConnector sC, ClusterName clusterName, TableMetadata stream, RowToInsert
            rowToInsert) {
        super("[DecisionInserter]");
    ...
    public DecisionInserter elementPerSecond(long elements) {
        this.elementPerSecond = elements;
        return this;
    }

    public DecisionInserter numOfElement(long elements) {
        this.numOfElement = elements;
        return this;
    }

    public DecisionInserter addTypeToInsert(ColumnType type) {
    ...
    public void run() {
        ...
        try {
            ...
            IStorageEngine storageEngine = decisionConnector.getStorageEngine();
