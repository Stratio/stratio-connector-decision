 ...
 * under the License.
 */
package com.stratio.connector.decision.ftest.functionalInsert;
...
import com.stratio.connector.decision.ftest.ResultHandlerTest;
import com.stratio.connector.decision.ftest.thread.actions.RowToInsertBigLong;
...
public class SimpleInsertFT extends GenericDecisionTest {
    ...
    public void insertIntTest() throws ConnectorException {
        ...
        DecisionRead reader = new DecisionRead(sConnector, logicalWorkFlow, resultSet);
        ...
        DecisionInserter decisionInserter = new DecisionInserter(sConnector, clusterName, tableMetadata,
                        new RowToInsertDefault());
        decisionInserter.numOfElement(10).elementPerSecond(5);
        decisionInserter.addTypeToInsert(new ColumnType(DataType.INT)).addTypeToInsert(new ColumnType(DataType.VARCHAR));
        decisionInserter.start();

        waitSeconds(15);

        decisionInserter.end();
        waitSeconds(10);
        reader.end();
    ...
    public void insertLongTest() throws ConnectorException {
        ...
        DecisionRead reader = startReader(resultSet, queryId);
    ...
    private void endReader(DecisionRead reader) {
        waitSeconds(15);
        reader.end();
    }
    ...
    private void insertValuesToStream(TableMetadata tableMetadata, RowToInsertDefault rowToInsert)
        ...
        DecisionInserter decisionInserter = new DecisionInserter(sConnector, getClusterName(), tableMetadata,
                        rowToInsert);
        decisionInserter.numOfElement(10).elementPerSecond(5);
        decisionInserter.addTypeToInsert(new ColumnType(DataType.BIGINT)).addTypeToInsert(new ColumnType(DataType.VARCHAR));
        decisionInserter.start();
    ...
    private DecisionRead startReader(IResultHandler resultHandlerTest, String queryId) throws UnsupportedException {
        // TODO window with 1element
        ...
        DecisionRead reader = new DecisionRead(sConnector, logicalWorkFlow, resultHandlerTest);
    ...
    public void insertBooleanTest() throws ConnectorException {
        ...
        decisionInserter.numOfElement(10).elementPerSecond(5);
        decisionInserter.start();
        decisionInserter.addTypeToInsert(new ColumnType(DataType.BOOLEAN)).addTypeToInsert(new ColumnType(DataType.VARCHAR));
        waitSeconds(10);
    ...
    public void insertFloatTest() throws ConnectorException {
        ...
        decisionInserter.numOfElement(10).elementPerSecond(5);
        decisionInserter.start();
        decisionInserter.addTypeToInsert(new ColumnType(DataType.FLOAT)).addTypeToInsert(new ColumnType(DataType.VARCHAR));
        waitSeconds(10);
    ...
    public void insertDoubleTest() throws ConnectorException {
        ...
        decisionInserter.numOfElement(10).elementPerSecond(5);
        decisionInserter.start();
        decisionInserter.addTypeToInsert(new ColumnType(DataType.DOUBLE)).addTypeToInsert(new ColumnType(DataType.VARCHAR));
        waitSeconds(10);
    ...
    public void insertStringTest() throws ConnectorException {
        ...
        decisionInserter.numOfElement(10).elementPerSecond(5);
        decisionInserter.start();
        decisionInserter.addTypeToInsert(new ColumnType(DataType.VARCHAR));
        waitSeconds(10);
