...
public class ThreadFilterIntegerFunctionalFT extends GenericStreamingTest {
    ...
    public void lowerFilterTest() throws InterruptedException, UnsupportedException {
        ...
        StreamingRead stremingRead = new StreamingRead(sConnector, createLowerLogicalWorkFlow(),
    ...
    public void greatFilterTest() throws InterruptedException, UnsupportedException {
        ...
        int correctValue = 6;
        int incorrectValue = OTHER_INT_VALUE;
        StreamingRead stremingRead = new StreamingRead(sConnector, createGreatLogicalWorkFlow(),
                        new ResultNumberHandler(correctValue, incorrectValue));
    ...
    public void greatEqualsFilterTest() throws InterruptedException, UnsupportedException {
        ...
        StreamingRead stremingRead = new StreamingRead(sConnector, createGreatEqualLogicalWorkFlow(),
                        new ResultNumberHandler(correctValue, incorrectValue));
    ...
    public void lowerEqualsFilterTest() throws InterruptedException, UnsupportedException {
        ...
        StreamingRead stremingRead = new StreamingRead(sConnector, createLowerEqualsLogicalWorkFlow(),
