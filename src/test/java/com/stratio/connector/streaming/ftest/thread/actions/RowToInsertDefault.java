 ...
 */
public class RowToInsertDefault extends RowToInsert {
    ...
    protected Cell getBooleanColumnCell() {
        return new Cell(true);
    }

    protected  Cell getDoubleCell(Integer value) {
        return new Cell(new Double(value + 0.5));
    }

    protected Cell getFloatCell(Integer value) {
        return new Cell(new Float(value + 0.5));
    }
    protected  Cell getIntCell(Integer value) {
        return new Cell(value);
    }

    protected  Cell getLongCell(Integer value) {
        return new Cell(new Long(value));
    }

    protected Cell getTextCell(String text) {
